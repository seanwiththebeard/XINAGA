...
void InitializeMapData()
{
  ...
  for (byte_y = 0; byte_y < 8; ++byte_y)
    for (byte_x = 0; byte_x < 8; ++byte_x)
    {
      ...
      ScreenQuad.Chars[byte_index][1] = 44;
...
const byte MapSet[2048] = { /*{w:8,h:8,brev:1,count:256, bpp:1, pal:"c64"}*/
  0x00,0x3C,0x60,0x40,0x40,0x40,0x00,0x00,0x00,0x3C,0x06,0x02,0x02,0x02,0x00,0x00
    ,0xE7,0x81,0x81,0x00,0x00,0x81,0x81,0xE7,0xE7,0x81,0x81,0x00,0x00,0x81,0x81,0xE7
    ...
    ,0x00,0x00,0x40,0x40,0x40,0x60,0x3C,0x00,0x00,0x00,0x02,0x02,0x02,0x06,0x3C,0x00
    ,0xE7,0x81,0x81,0x00,0x00,0x81,0x81,0xE7,0x00,0x3E,0x1C,0x00,0x00,0x00,0x7C,0x00
